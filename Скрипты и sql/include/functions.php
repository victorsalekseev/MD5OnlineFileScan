<?php
function get_fileinfo($table_name, $enc, $hash, $db_n, $db_hn, $db_u, $db_p)//Имя таблицы, кодировка, имя словаря
{
if(mb_strlen($hash)<>32) die ('Error formatting Hash.');
...
$out_t=$out_t.'<table border=0 cellpadding=0 cellspacing=0 width=400><tr><td align=center nowrap>Хеш <b>'.$w_pr.'</b>.<br />Просмотрено:&nbsp;'.$sum_rows[0].', найдено:&nbsp;'.$num_rows.', затрачено '.round(STOP_TIME, 4).' секунд.</td></tr></table><br />';
